...
const url =
  "https://www.youtube.com/playlist?list=PLRBp0Fe2GpglTnOLbhyrHAVaWsCIEX53Y";
let cTab;
...
(async function () {
  try {
    ...
    let allData = await cTab.evaluate(
      getData,
      ".style-scope.ytd-playlist-byline-renderer"
    );
    ...
    fs.writeFileSync("thing.json", JSON.stringify(finalList));
